...
module.exports = "<p>\n  This is what I'm all about <a href=\"\" (click)=\"sendMeBack()\"><strong>Go Back</strong></a>\n</p>\n\n<ul>\n  <li *ngFor=\"let goal of goals\">\n    {{ goal }}\n  </li>\n</ul>"
...
var AboutComponent = /** @class */ (function () {
    function AboutComponent(route, router, _data) {
        ...
        this.router = router;
        this._data = _data;
        this.route.params.subscribe(function (r) { return console.log(r.id + r.id1); });
    }
    AboutComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._data.goal.subscribe(function (res) { return _this.goals = res; });
    };
    AboutComponent.prototype.sendMeBack = function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__whether_whether_component__ = __webpack_require__("./src/app/whether/whether.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    {
        path: 'whether',
        component: __WEBPACK_IMPORTED_MODULE_5__whether_whether_component__["a" /* WhetherComponent */]
    }
];
...
module.exports = "<ul>\n  <li><a routerLink=\"home\">Home</a></li>\n  <li><a routerLink=\"about/48/52\">About</a></li>\n  <li><a routerLink=\"service\">Service</a></li>\n  <li><a routerLink=\"whether\">Whether</a></li>\n</ul>\n\n<router-outlet></router-outlet>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__whether_whether_component__ = __webpack_require__("./src/app/whether/whether.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__webservice_webservice_component__ = __webpack_require__("./src/app/webservice/webservice.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_12__whether_whether_component__["a" /* WhetherComponent */],
                __WEBPACK_IMPORTED_MODULE_13__webservice_webservice_component__["a" /* WebserviceComponent */]
            ],
            imports: [
...
var DataService = /** @class */ (function () {
    function DataService() {
        this.goals = new __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__["a" /* BehaviorSubject */](['Goal One', 'Goal Two', 'Goal Three']);
...
module.exports = "<div class=\"container color-dark\">\n  <div class=\"col\">\n    <p>Add a bucket list item</p>\n  </div>\n  <div class=\"col\">\n    <p>Your bucket list ({{ itemCount }})</p>\n  </div>\n</div>\n<div class=\"container color-light\">\n  <div class=\"col\"> \n    <p class=\"sm\">Use this form to add new bucket list goal.</p>\n\n    <form>\n      <input type=\"text\" class=\"txt\" name=\"item\" placeholder=\"Life Goal...\" [(ngModel)]=\"goal\"> \n      <!-- [(ngModel)]=\"goal\" -->\n      <input type=\"submit\" class=\"btn\" [value]=\"add\" (click)=\"addItem()\">\n    </form>\n\n  </div>\n  <div class=\"col\">\n    <p class=\"life-container\" *ngFor=\"let gl of goals\">\n      {{ gl }}\n    </p>\n  </div>\n</div>\n"
...
var ServiceComponent = /** @class */ (function () {
    function ServiceComponent(_data) {
        this._data = _data;
    }
    ServiceComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._data.goal.subscribe(function (res) { return _this.goooaaals = res; });
    };
...
/***/ "./src/app/webservice/webservice.component.scss":
/***/ (function(module, exports) {
...
var WebserviceComponent = /** @class */ (function () {
    function WebserviceComponent(httpClient) {
    ...
    WebserviceComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            ...
            styles: [__webpack_require__("./src/app/webservice/webservice.component.scss")]
        }),
...
/***/ "./src/app/whether/whether.component.html":
/***/ (function(module, exports) {

module.exports = "<p>\n  Enter city name\n</p>\n\n<input type=\"text\" [(ngModel)]=\"city\" >   \n<input type=\"submit\" (click)=\"search()\" value=\"Search\">\n\n<h3>Humidity in {{city}} is {{humid}}</h3>\n<h3>Pressure in {{city}} is {{pres}}</h3>\n<h3>Temperature in {{city}} is {{temp}}</h3>\n\n\n"

/***/ }),

/***/ "./src/app/whether/whether.component.scss":
/***/ (function(module, exports) {
...
/***/ "./src/app/whether/whether.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var WhetherComponent = /** @class */ (function () {
    function WhetherComponent(http) {
        this.http = http;
        this.city = "";
    }
    WhetherComponent.prototype.ngOnInit = function () {
    };
    WhetherComponent.prototype.search = function () {
        var _this = this;
        this.http.get('http://api.openweathermap.org/data/2.5/weather?APPID=0ba5e82df49a15a79cec569618c56215&q=' + this.city)
            ...
            _this.humid = weatherCity.main.humidity;
            _this.pres = weatherCity.main.pressure;
            _this.temp = weatherCity.main.temp;
        });
    };
    WhetherComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-whether',
            template: __webpack_require__("./src/app/whether/whether.component.html"),
            styles: [__webpack_require__("./src/app/whether/whether.component.scss")]
        }),
